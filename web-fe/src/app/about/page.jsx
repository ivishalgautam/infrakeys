...
export const metadata = {
  title:
    "About Infrakeys Technologies. Binding Wire and Wire Mesh, Steel Manufacturers, Scaffolding Manufacturers",
  description:
    "Infrakeys Steel India is the most trusted manufacturer, supplier and exporter of high quality stainless steel pipes, door & window, metal fabrication at best prices.",
  keywords:
